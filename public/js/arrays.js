export function exportAllArrays() {
    ...
    console.group('Užduotys');
    {
        ...
        const brazauskasAMB = ['algirdas', 'mykolas', 'brazauskas'];
        const addFirstLetters = (givenArray) => givenArray.reduce((pradineVerte, pridedamasZodis) => pradineVerte + pridedamasZodis[0], '');
        ...
        {
            const dauginamSkaicius = (masyvas) => masyvas.reduce((pagrindinis, duomuo) => pagrindinis * duomuo);
            const array = [5, 3, 10];
